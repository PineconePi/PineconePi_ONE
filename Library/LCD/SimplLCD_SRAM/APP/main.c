...
uint16_t LCD_Buffer[480*272 * 2 / 2] __attribute__((at(SRAMM_BASE))) = {0};

#elif defined ( __ICCARM__ )

uint32_t *LCD_Buffer = (uint32_t *)SRAMM_BASE;
...
void MemoryInit(void)
{
	...
	SRAM_InitStruct.ClkDiv = SRAM_CLKDIV_5;		//主频40MHz时可选SRAM_CLKDIV_5，主频120MHz时一般选SRAM_CLKDIV_8
