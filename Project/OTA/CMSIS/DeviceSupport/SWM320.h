...
typedef struct {
	...
	__IO uint32_t REMAP;					//0 程序在ROM中执行	   1 程序在FLASH中执行
    ...
    __IO uint32_t TEMPCR;                   //温度传感器控制寄存器
...
#define SYS_HRC20M_R_Pos	        0		//HRC 20MHz粗调控制位
#define SYS_HRC20M_R_Msk	        (0x3FFF << SYS_HRC20M_R_Pos)
#define SYS_HRC20M_F_Pos		    16		//HRC 20MHz细调控制位
#define SYS_HRC20M_F_Msk		    (0x7FF << SYS_HRC20M_F_Pos)

#define SYS_HRC40M_R_Pos	        0		//HRC 40MHz粗调控制位
#define SYS_HRC40M_R_Msk	        (0x3FFF << SYS_HRC40M_R_Pos)
#define SYS_HRC40M_F_Pos		    16		//HRC 40MHz细调控制位
#define SYS_HRC40M_F_Msk		    (0x7FF << SYS_HRC40M_F_Pos)

#define SYS_TEMPCR_OFF_Pos		    0		//温度传感器关闭
#define SYS_TEMPCR_OFF_Msk		    (0x01 << SYS_TEMPCR_OFF_Pos)
#define SYS_TEMPCR_TRIM_Pos		    4		//温度传感器TRIM
...
#define SYS_BODIE_1V9_Pos		    0       //BOD 1.9V等级触发中断使能
...
#define SYS_BODIF_1V9_Pos		    0       //BOD 1.9V等级触发中断状态，写1清零
...
//#define ADC_IE_CH7FULL_Msk			(0x01 << ADC_IE_CH7FULL_Pos)	编译器警告： integer operation result is out of range
...
typedef struct {
    ...
    __IO uint32_t SRCADDR;                  //数据源地址寄存器，30位宽，低两位自动补零
...
#define LCD_CR0_DLEN_Pos			0		//MPU接口时，此次操作的数据长度，单位为字节，0表示1个
...
#define LCD_CR1_REG_Pos				0		//LCD_CR1_CMD_Pos取值1时，寄存器索引值
#define LCD_CR1_REG_Msk				(0xFFFF << LCD_CR1_REG_Pos)
#define LCD_CR1_I80_Pos			    16		//1 接口为I80    0 接口为M68
#define LCD_CR1_I80_Msk			    (0x01 << LCD_CR1_I80_Pos)
#define LCD_CR1_CMD_Pos				17		//0 数据传输，即RS为高电平    1 命令传输，即传输寄存器索引，即RS为低电平
#define LCD_CR1_CMD_Msk				(0x01 << LCD_CR1_CMD_Pos)
#define LCD_CR1_TTAIL_Pos			18		//CSn上升沿到CSn下降沿的时间
#define LCD_CR1_TTAIL_Msk			(0x07 << LCD_CR1_TTAIL_Pos)
#define LCD_CR1_TAH_Pos			    21		//WRn上升沿到CSn上升沿的时间
#define LCD_CR1_TAH_Msk			    (0x03 << LCD_CR1_TAH_Pos)
#define LCD_CR1_TPWLW_Pos			23		//WRn低电平的持续时间
#define LCD_CR1_TPWLW_Msk			(0x07 << LCD_CR1_TPWLW_Pos)
#define LCD_CR1_TAS_Pos			    26		//CSn下降沿到WRn下降沿的时间
